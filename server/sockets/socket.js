...
io.on('connection', (client) => {
    ...
    client.on('disconnect', () => {
        ...
        client.broadcast.to(personaBorrada.para).emit('crearMensaje',crearMensaje('Administrador',personaBorrada.nombre+ " salio"))
        client.broadcast.to(personaBorrada.para).emit('listaPersona', usuarios.getPersonasPorSala(personaBorrada.para))
